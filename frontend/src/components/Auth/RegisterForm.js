...
function RegisterForm(props) {
  return (
    <>
        ...
        <Input handleEnter={props.handleEnter} value={props.repeatedPassword} setValue={props.setRepeatedPassword} label="Password" type="password" placeholder="Repeat your password"/>
    </>
  )
}
